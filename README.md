...
A Python script that generates randomized 45-card decks for the card game Mood Swings.

## Features

- Generates randomized decks with proper rarity distribution
- 23 commons, 14 uncommons, 6 rares, 2 mythic rares
- Displays deck statistics including color breakdown
...
This will generate and display a randomized deck with the following information:

- All 45 cards organized by rarity and color
- Rarity breakdown
- Color breakdown
